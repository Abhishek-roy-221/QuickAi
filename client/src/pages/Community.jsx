...
group-hover:bg-gradient-to-b from-transparent to-black/80 text-white rounded-lg'>
    ...
    <div className='flex justify-center items-ccenter h-full'>
      <span className='w-10 h-10 my-1 rounded-full border-3 border-primry border-t-transparent animate-spin'></span>
    </div>
  )
}
