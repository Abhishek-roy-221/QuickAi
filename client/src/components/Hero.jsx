    ...
    justify-center bg-[url(/gradientBackground.png)] bg-cover bg-no-repeat
     min-h-screen'>
        <div className='text-center mb-6'>
            ...
            font-semibold mx-auto loading-[1.2]'>Build Smarter, Faster, Better <br/> with <span className='text-primary'>AI Tools</span></h1>
            <p className='mt-4 max-w-xs sm:max-w-lg 2xl:max-w-xl m-auto max-sm:text-xs text-gray-600'>All-in-one AI toolkit to write, design, and create faster. Save time and focus on what truly matters — your ideas.</p>
        </div>
