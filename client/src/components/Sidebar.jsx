...
const navItems = [
    ...
    { to: '/ai/remove-backgrond', label: 'Remove Background', Icon: Eraser },
            ...
            <div className='my-7 w-full'>
                ...
                <div className='px-6 mt-5 text-sm text-gray-600 font-medium'>
                    ...
                    {navItems.map(({to,label,Icon}) => (
                        ...
                        `px-3.5 py-2.5 flex items-center gap-3 rounded ${isActive ? 'bg-gradient-to-r from-[#3C81F5] to-[#9234EA] text-white' : ''}`}>
                            { ({isActive})=>(
                                <>
...
<div onClick={openUserProfile} className='flex gap-2 i tems-center cursor-pointer'>
...
<LogOut onClick={signOut} className='w-4.5 text-gray-400 hover:text-gray-700 transiton cursor-pointer'/>
</div>
        </div>
    )
}
