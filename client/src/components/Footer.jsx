    ...
    <div className="flex flex-col md:flex-row justify-between w-full gap-10 border-b border-gray-500/30 pb-6">
        <div className="md:max-w-96">
            ...
            <p className="mt-6 text-sm">
                Quick AI is your all-in-one platform for smarter content creation. <br/> From writing articles to generating ideas, it helps you work faster and more creatively with powerful AI tools. Whether you’re a student, creator, or business, Quick AI makes productivity effortless.
            </p>
        </div>
